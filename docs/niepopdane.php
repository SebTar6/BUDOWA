...
<main>
    ...
    <h3>NIEPOPRAWNE DANE LOGOWANIA</h3>
    <div class="row col-12 pb-5">
        <div class="col-md-12">
            <table class="table text-center">
                <tbody>
                <tr>
                    <td><button type="button" class="button-add" onclick="location.href='logowanie.html'">Zaloguj</button></td>
                </tr>
                <tr>
                    <td><button type="button" class="button-add" onclick="location.href='rejestracja.html'">Nie mam konta</button></td>
                </tr>
                </tbody>
            </table>
