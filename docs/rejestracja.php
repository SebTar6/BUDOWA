        ...
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <form method="post" action="funkcje.php">
                    <button class="nav-link active buttons" type="submit" name="akcja" value="zamowienie">Zamówienie</button>
                </form>
            </li>
            <li class="nav-item">
        ...
        <div class="col-md-12">
            <form method="post" action="funkcje.php">
                ...
                <div class="text-center">
                    <button type="submit" class="button-add" name="akcja" value="rejestracja">Zarejestruj</button>
                </div>
            </form>
        </div>
    </div>
